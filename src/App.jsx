      ...
      <div className="calculator_container">
        ...
        <div className="tip_portion">
          ...
          <div className="tip_buttons">
            <button className="tip_button button_5" type="button">5%</button>
            <button className="tip_button button_10" type="button">10%</button>
            <button className="tip_button button_15" type="button">15%</button>
            <button className="tip_button button_25" type="button">25%</button>
            <button className="tip_button button_50" type="button">50%</button>
            <button className="tip_button button_custom" type="button">Custom</button>
          </div>
        </div>
        {/* tip portion ends */}
        ...
        <div className="results_portion">
          ...
          <div className="amount_container">
            ...
            <p className="tip_amount">$32.79</p>
          </div>
