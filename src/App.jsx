...
function Bill({ billRegex, validation, onBillHandle, onBillType, billError }) {
...
function PeopleAmount({ numVal, onPeopleHandle, validation, peopleError }) {
...
function Results({ billAmount, tip, people, billError, tipError, peopleError }) {
  ...
  return (
    <div className="container">
      ...
      <div className="calculator_container">
        ...
        <Bill billError={error.billError} validation={(e) => validateBill(e)} onBillType={(e) => handleBillChange(e)} onBillHandle={(e) => returnBillAmount(e)}  />
        {/* upper portion ends */}
        {/* tip portion begins */}
        ...
        <PeopleAmount peopleError={error.numPeopleError} validation={(e) => validatePeople(e)} onPeopleHandle={(e) => handleBillChange(e)}  numVal={(e) => returnNumOfPeople(e)} />
        {/* number of people portion ends */}
        {/* results portion begins */}
        <Results billError={error.billError} tipError={error.customTipError} peopleError={error.numPeopleError} billAmount={billAmount.amount} tip={billAmount.tip} people={billAmount.numPeople} />
